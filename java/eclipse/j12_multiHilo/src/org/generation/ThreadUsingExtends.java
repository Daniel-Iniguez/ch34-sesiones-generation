...
class MyThread extends Thread {
	...
	public void run() {
		for (int i = 0; i < 5; i++) {
			System.out.println("id: " + super.threadId() + ", name: " + super.getName() 
			   + ", iteration n: " + i);
			try {
...
public class ThreadUsingExtends {
	public static void main(String[] args) {
		...
		System.out.println("Hilo01 isAlive: " + hilo01.isAlive() );
		System.out.println("Hilo02 isAlive: " + hilo02.isAlive() );
		System.out.println("Hilo03 isAlive: " + hilo03.isAlive() );
