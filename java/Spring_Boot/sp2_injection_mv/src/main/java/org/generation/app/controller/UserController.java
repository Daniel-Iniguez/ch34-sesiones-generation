...
public class UserController {
	...
	/*
	 *  Request Param
	 *  Vincula los parámetros de una solicitud HTTP con los parámetros del método.
	 *  Permite extraer los valores de los parámetros de la consulta (query parameters).
	 *  Si no se proporciona los valores, se genera la excepción MissingServletRequestParametersException
	 *  
	 */
